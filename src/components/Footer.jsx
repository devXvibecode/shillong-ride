  ...
  return (
    <footer className="mt-auto border-t border-white/5">
      <div className="relative">
        <div className="h-2 bg-gradient-to-r from-orange-800 via-orange-600 to-orange-800" />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-12 mb-10">
            ...
            <div>
              ...
              <div className="space-y-1.5 border-l-2 border-white/10 pl-3">
                ...
                <p className="text-white/55 text-sm">hello@shillongride.in</p>
                ...
                <p className="text-white/55 text-sm">+91 9591794044</p>
              </div>
            </div>
          </div>
