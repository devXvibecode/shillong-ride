        ...
        <div className="max-w-7xl mx-auto px-4 py-12 sm:py-16">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-10 sm:gap-12 mb-10">
            <div>
              ...
              <p className="text-white/55 text-sm mt-3 max-w-xs leading-relaxed border-l-2 border-orange-500/30 pl-3">
            ...
            <div>
              ...
              <div className="space-y-1.5 border-l-2 border-white/10 pl-3">
                <p className="text-white/55 text-sm">Shillong, Meghalaya</p>
                <a href="mailto:hello@shillongride.in" className="text-white/55 hover:text-orange-400 transition-colors text-sm block">hello@shillongride.in</a>
                <p className="text-white/55 text-sm text-orange-400/60 text-[10px] font-['Anton'] uppercase tracking-wider mt-1.5">Enquiry &amp; Emergency</p>
                <a href="tel:+919591794044" className="text-white/55 hover:text-orange-400 transition-colors text-sm block">+91 9591794044</a>
              </div>
            </div>
          </div>
          <div className="border-t border-white/5 pt-6 text-center">
            <p className="text-white/55 text-xs font-mono tracking-wider">
