    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-white border-4 border-black shadow-[12px_12px_0px_#000] max-w-lg w-full p-6 sm:p-8"
        ...
        >
          ...
          <div className="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-4 mb-5 max-h-40 overflow-y-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              type="button"
              onClick={onClose}
              className="bg-white border-4 border-black shadow-[4px_4px_0px_#000] flex-1 py-3 text-xs font-black uppercase tracking-wider hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#000] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all"
            >
              Cancel
            </button>
            <button
    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          exit={{ opacity: 0, scale: 0.85, y: 20 }}
          transition={{ type: 'spring', stiffness: 200, damping: 18 }}
          className="bg-white border-4 border-black shadow-[12px_12px_0px_#000] max-w-md w-full p-6 sm:p-8"
          onClick={e => e.stopPropagation()}
        >
          {/* WhatsApp Icon */}
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-green-500 border-4 border-black shadow-[4px_4px_0px_#000] flex items-center justify-center">
          ...
          <div className="bg-white border-4 border-black shadow-[4px_4px_0px_#000] p-4 mb-6">
            <p className="text-black/50 text-[10px] font-['Anton'] uppercase tracking-wider mb-2">Preview</p>
            <div className="text-black/70 text-[11px] font-mono whitespace-pre-wrap leading-relaxed">
