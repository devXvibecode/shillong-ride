    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="neo-card-dark max-w-lg w-full p-6 sm:p-8"
          onClick={e => e.stopPropagation()}
        >
          <div className="flex items-center justify-between mb-5">
            <h3 className="font-['Anton'] text-white text-lg tracking-wider">
              Send WhatsApp
            </h3>
            <button
              type="button"
          ...
          <p className="text-white/60 text-xs mb-4">Select a message template for {booking.name}:</p>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className={`text-xs font-bold uppercase tracking-wider ${
                    selected === id ? 'text-orange-400' : 'text-white/70'
                  }`}>
                    {tmpl.label}
                  </span>
                </div>
                <p className="text-white/40 text-[10px] mt-1 font-mono line-clamp-1">
          ...
          <div className="neo-card-dark p-4 mb-5 bg-[#16161f] max-h-40 overflow-y-auto">
