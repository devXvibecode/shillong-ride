    ...
    <div className="py-12">
      ...
      <div className="grid sm:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <motion.button
          ...
          className="neo-card group text-left border-yellow-500"
        >
          <div className="bg-yellow-500 text-black w-12 h-12 flex items-center justify-center font-anton text-2xl mb-6">02</div>
